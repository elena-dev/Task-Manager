...
const mutations = {
    ...
    updateTask(state,payload){
        ...
        state.taskList[payload.index].levelText = this.state.all.levels.find(x => x.id === payload.levelId).text
        ...
        state.taskList[payload.index].date = payload.date
        state.taskList[payload.index].user = payload.user
        state.taskList[payload.index].name = payload.name
    },
